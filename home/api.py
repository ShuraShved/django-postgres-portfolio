...
@router.post("/add-contact/", auth=django_auth)
#@csrf_protect
...
@router.post("task/create/", auth=django_auth)
...
@router.delete("task/{task_id}/delete/", auth=django_auth)
...
@router.post("task/{task_id}/update-time-management/", auth=django_auth, response=TaskResponseSchema)
...
@router.post("task/{task_id}/{status}/", auth=django_auth)
...
@router.post("task/{task_id}/reup/", auth=django_auth)
...
@router.post("task/{task_id}/edit/", auth=django_auth)
...
@router.post("/task-person/save/", auth=django_auth)
